...
error sniff(void *const data, size_t const len, wchar_t const **const mime, wchar_t const **const ext) {
  ...
  if (b[0] == 'G' && b[1] == 'I' && b[2] == 'F' && b[3] == '8' && (b[4] == '7' || b[4] == '9') && b[5] == 'a') {
    ...
    ext_ = L".jpg";
    mime_ = L"image/jpeg";
  } else if (b[0] == 0x89 && b[1] == 'P' && b[2] == 'N' && b[3] == 'G' && b[4] == 0x0d && b[5] == 0x0a &&
             b[6] == 0x1a && b[7] == 0x0a) {
    ext_ = L".png";
    mime_ = L"image/png";
  } else if (b[0] == 'R' && b[1] == 'I' && b[2] == 'F' && b[3] == 'F' && b[8] == 'W' && b[9] == 'E' && b[10] == 'B' &&
             b[11] == 'P') {
    ext_ = L".webp";
    mime_ = L"image/webp";
    ...
    ext_ = L".bmp";
    mime_ = L"image/bmp";
  } else if (b[0] == 'F' && b[1] == 'O' && b[2] == 'R' && b[3] == 'M' && b[8] == 'A' && b[9] == 'I' && b[10] == 'F' &&
             b[11] == 'F') {
    ext_ = L".aiff";
    mime_ = L"audio/aiff";
  ...
  } else if (b[0] == 'M' && b[1] == 'T' && b[2] == 'h' && b[3] == 'd' && b[4] == 0x00 && b[5] == 0x00 && b[6] == 0x00 &&
             b[7] == 0x06) {
    ext_ = L".mid";
    mime_ = L"audio/midi";
  } else if (b[0] == 'R' && b[1] == 'I' && b[2] == 'F' && b[3] == 'F' && b[8] == 'A' && b[9] == 'V' && b[10] == 'I' &&
             b[11] == ' ') {
    ext_ = L".avi";
    mime_ = L"video/avi";
  } else if (b[0] == 'R' && b[1] == 'I' && b[2] == 'F' && b[3] == 'F' && b[8] == 'W' && b[9] == 'A' && b[10] == 'V' &&
             b[11] == 'E') {
    ext_ = L".wav";
    mime_ = L"audio/wave";
